...
const updById = `
query updById($id: String!, priority: Int, columnId: Int, name: String, index: Int) {
    updateTask(id: $id, priority: 1, )
}
`;
...
mutation updateTask($id: String!, $columnId: Int!) {
    updateTask(id: $id, columnId: $columnId)
}
`;
...
export default class Card extends Component{
    ...
    selNewState(event){
        ...
        this._queryState(id, event.target.value)
    }

    _queryState(id, newcolumnId){
        quer(selectNewState, { id: id, columnId: newcolumnId } )
        .then((a)=>{
            console.log(a)
        });
    }
